...
class Login_window:
    def __init__(self,root):
        ...
        btn_login=cus.CTkButton(login_frame,text="Entrer",text_color="white", text_font=("times new roman",18,"bold"),fg_color="purple",bg_color="white", cursor="hand2",command=self.login).place(x=100,y=350,width=scr_width/9)
